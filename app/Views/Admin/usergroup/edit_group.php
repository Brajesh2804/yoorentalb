...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?= base_url('admin/usergroup') ?>" class="btn btn-primary btn-sm">Back</a>
        </div>
        <div class="card-body">
            <form action="<?= current_url(); ?>" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="_name"
                            value="<?= $prev_details->_name ?? '' ?>" placeholder="Group Name">
                        <span
                            class="text-danger"><?= isset($validation['_name']) ? $validation['_name'] : '' ?></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php foreach ($menulist as $key => $menu) {
                                ...
                                $ismenuexist = $commonmodel->getOneRecord(
                                    'tbl_privilege',
                                    ['privilege_id' => $prev_details->privilege_id, 'menu_id' => $menu->menu_id]
                                );
                                if ($ismenuexist) {
                                    $menuchecked = 'checked';
                ...
                <div class="mt-3">
                    ...
                    <a href="<?= base_url('admin/usergroup') ?>" class="btn btn-warning btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </div>
