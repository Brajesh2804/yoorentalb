                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" value="<?=set_value('email',$user->email)?>" class="form-control">
                            ...
                            <div class="form-group px-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" value="0" id="status2" <?=($user->status < 1)?'checked':''?>>
