    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo" href="index.html"><img src="<?=base_url('assets/admin/images/logo1c.png') ?>" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?=base_url('assets/admin/images/logo1a.png') ?>" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="<?=base_url('assets/admin/images/faces/face28.jpg') ?>" alt="image">
                  <span class="availability-status online"></span>
                </div>
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Brajesh Maurya</p>
                </div>
              </a>
            ...
            <li class="nav-item nav-profile">
              <a href="" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Brajesh Maurya</span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('assets/admin/pages/ui-features/buttons.html') ?>">Buttons</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('assets/admin/pages/ui-features/dropdowns.html') ?>">Dropdowns</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('assets/admin/pages/ui-features/typography.html') ?>">Typography</a>
                  </li>
                </ul>
              </div>
            </li>
